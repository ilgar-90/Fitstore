...
public class CarouselPagerAdapter extends FragmentPagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public CarouselPagerAdapter(ActiveFragment fragment, FragmentManager fm) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        try {
            if (position == fragment.FIRST_PAGE)
                scale = BIG_SCALE;
            else
                scale = SMALL_SCALE;

            position = position % fragment.count;
    ...
    private String getFragmentTag(int position) {
        return "android:switcher:" + fragment.pager.getId() + ":" + position;
    }
}